...
public class StereoController : MonoBehaviour {
  ...
  private void CreateEye(Cardboard.Eye eye) {
	...
	public void OnObjectRadiusChange(float value)
	{

		Debug.Log("radius value: " + value);
		radiusOfInterest = value;
	}

	public void OnSteroMultiplerChange(float value)
	{
		stereoMultiplier = value;
	}
  ...
  void OnDisable() {
	...
	void Update()
	{
		Debug.Log("setting left: " + LeftEyeOffset);
		Cardboard.SDK.EyeOffset(Cardboard.Eye.Left).Set(LeftEyeOffset,LeftEyeOffset,LeftEyeOffset);
	}
